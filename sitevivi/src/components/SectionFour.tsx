        ...
        <div className="bg-black/40 backdrop-blur-md border border-cinema-neon/30 p-8 rounded-lg shadow-lg shadow-cinema-neon/20 animate-float max-w-lg mx-auto">
          ...
          {!response ? (
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              >
                Sim também (sou antidemocrático).
              </button>
            </div>
          ) : (
            <div className="animate-fade-in">
              {response === "sim" ? (
                <p className="text-xl font-orbitron text-white">
                  ...
                  <span className="text-cinema-neon">Nossa história está apenas começando.</span>
                </p>
              ) : (
                <p className="text-xl font-orbitron text-white">
                  AINDA BEM. <br />
                  <span className="text-cinema-neon">Estou ansioso para dividir meus sonhos com os seus.</span>
                </p>
              )}
